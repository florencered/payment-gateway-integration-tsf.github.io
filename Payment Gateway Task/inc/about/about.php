			...
			'recommended_actions'        => array(
				...
				'content'            => array(
					'magical-blocks' => array(
						'title'       => __('Magical Posts Display', 'portfoliox-dark'),
...
function portfoliox_dark_new_optins_texts()
{
	...
	printf('<div class="%1$s" style="padding:10px 15px 20px;text-transform:uppercase"><p>%2$s</p><a target="_blank" class="button button-primary" href="%3$s" style="margin-right:10px">' . __('PortfolioX Pro Details', 'portfoliox-dark') . '</a><a target="_blank" class="button button-primary" href="%4$s" style="margin-right:10px">' . __('Upgrade Pro', 'portfoliox-dark') . '</a><button class="button button-info btnend" style="margin-left:10px">' . __('Dismiss the notice', 'portfoliox-dark') . '</button></div>', esc_attr($class), wp_kses_post($message), $url1, $url3);
}
